    ...
    def train(self, sess, cat, max_it=8000):
        ...
        for k in range(max_it+1):
            ...
            if not test:
                ...
                ind = [features[rd.randint(0, len(features) - 1)] for _ in range(batch_size)]
                ...
                ind = [valid_features[rd.randint(0, len(valid_features) - 1)] for _ in range(test_batch_size)]
                ...
                print('Iteration No. {:4d}: VALIDATION STEP, loss: {:.4f}'
