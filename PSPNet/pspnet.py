...
import PSPNet.layers_builder as layers
...
class PSPNet(object):
    ...
    def __init__(self, nb_classes, resnet_layers, input_shape, weights):
        ...
        json_path = join("PSPNet", "weights", "keras", weights + ".json")
        h5_path = join("PSPNet", "weights", "keras", weights + ".h5")
    ...
    def set_npy_weights(self, weights_path):
        ...
        npy_weights_path = join("PSPNet", "weights", "npy", weights_path + ".npy")
        json_path = join("PSPNet", "weights", "keras", weights_path + ".json")
        h5_path = join("PSPNet", "weights", "keras", weights_path + ".h5")
